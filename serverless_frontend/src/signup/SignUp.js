...
function SignUpForm(props) {
        ...
        userPool.signUp(
            ...
            function (err, result) {
                ...
                if (!err) {
                    ...
                    ReactSession.set('cusno', cusno);
                    subscribeEmail(inputValues.email);
    ...
    const subscribeEmail = async (email) => {
        ...
        axios.post('https://sak2jfjis4gaw47mdd5pcncenu0foyoa.lambda-url.us-east-1.on.aws/', requestBody).then((response) => {
